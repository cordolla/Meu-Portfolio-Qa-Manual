...
| **CP_06** | **Após compra com sucesso redirecionar para a "Home Page"** | Transição de Estado | Ter executado o caso **CP_03** (Finalizar Compra) | 1. Clicar no botão "OK" no pop up | N/A | O sistema deve redirecionar o usuario pra a Home Page. |  |
